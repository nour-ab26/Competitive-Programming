...
// Array to store the number of operations to reduce each number to zero
...
void precompute() {
    // Compute the number of operations for each number
    ...
    // Build the prefix sum array for fast range queries
    for (int i = 1; i <= MAXN; ++i) {
